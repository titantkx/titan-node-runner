...
```bash
docker run --rm -it -v ./data:/root/data titantkx/titan-node-runner:1.3.1 --chain-type mainnet --node-type sentry --sync-type full --moniker test-node --ext-addr "0.0.0.0:26656" --log warn
```
